...
const Contact = () => {
  ...
  const resetForm = () => {
    ...
    setButtonState({ text: "Submit", color: "text-white" }); // Reset the button state
  };
  ...
  return (
    <>
      ...
      <div className="contact flex flex-col sm:flex-col md:flex-row gap-5 text-white">
